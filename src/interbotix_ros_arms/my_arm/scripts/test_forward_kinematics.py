...
# from forward_kinematics_poe import forward_kinematics
from forward_kinematics_dh import forward_kinematics
...
class Manipulator():
    def __init__(self):
        ...
        test_case = [pi/4, -pi/4, -pi/4]  # joint angle in radian
