...
echo_and_run cd "/home/reek/interbotix_ws/src/interbotix_ros_arms/interbotix_sdk"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/reek/interbotix_ws/src/interbotix_ros_arms/interbotix_sdk/setup.py" \
     \
    build --build-base "/home/reek/interbotix_ws/build/interbotix_ros_arms/interbotix_sdk" \
    install \
    --root="${DESTDIR-/}" \
